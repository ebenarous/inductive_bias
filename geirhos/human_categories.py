...
import geirhos.wordnet_functions as wf
...
class HumanCategories(object):
    ...
    # Custom added CIFAR10 indices, because of 10->7 compression, indices: 5->4, 8->5, 9->6
    CIFAR10_airplane_indices = [0]
    CIFAR10_car_indices = [1]
    CIFAR10_bird_indices = [2]
    CIFAR10_cat_indices = [3]
    # CIFAR10_deer_indices = [4]
    CIFAR10_dog_indices = [4]
    # CIFAR10_frog_indices = [6]
    # CIFAR10_horse_indices = [7]
    CIFAR10_boat_indices = [5]
    CIFAR10_truck_indices = [6]

    def get_cifar10_indices_for_category(self, category):
        ...
        try: # Ignore if not one of the 7 classes that don't match categories
            return getattr(self, "CIFAR10_"+category+"_indices")
        except:
            return None
